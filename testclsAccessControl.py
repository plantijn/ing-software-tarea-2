...
class ClsAccessControlTester(unittest.TestCase):
    ...
    def testClsAccessControlLength_password(self):
        aClsAccessControl = clsAccessControl() 
        
        c0 = ""
        self.assertEqual(0, aClsAccessControl.length_password(c0))
        
        c1 = "M3A0$d8"  #Longitud 7    caracteres validos
        self.assertEqual(7, aClsAccessControl.length_password(c1))
        
        c2= "pa$$w0rD"  #longitud 8    caracteres validos
        self.assertEqual(8, aClsAccessControl.length_password(c2))
       
        c3 = "16.9rh@Ag5wxQzp0"  #longitud 16    caracteres validos
        self.assertEqual(16, aClsAccessControl.length_password(c3))
        
        c4 = "pa$$w0rD."  #longitud 9    caracteres validos
        self.assertEqual(9, aClsAccessControl.length_password(c4))
       
        c5 = "16.9rh@AgwxQzp0"  #longitud 15    caracteres validos
        self.assertEqual(15, aClsAccessControl.length_password(c5))
        
        c6 = "C*@d$.3Aca#a3aE+$"    #longitud 17    caracteres validos
        self.assertEqual(17, aClsAccessControl.length_password(c6))